...
class Agent:
    ...
    def model(self):
        ...
        # model.add(GRU(units=8,input_shape=(self.state_size,1),return_sequences=True))
        ...
        # model.add(Dropout(rate=0.4)) # was not found to be useful, in case of extended state and 
        # more stable results, regularization should normally be necessary
    ...
    def replay(self, batch_size):
        ...
        stateBatch = np.zeros((batch_size,self.state_size,1))
